...
export function EmptyArea(props: EmptyAreaProps) {
  ...
  return (
    <div
      className="w-full h-full max-h-64 bg-gray-200 rounded border-2 border-dashed border-black/30 cursor-pointer flex justify-center items-center hover:scale-105 active:scale-100 transition-all"
      onClick={() => onClick?.()}
    >
